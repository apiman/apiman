...
CREATE TABLE contracts (id BIGINT NOT NULL, apikey VARCHAR(255) NOT NULL, created_by VARCHAR(255) NOT NULL, created_on datetime NOT NULL, appv_id BIGINT NULL, planv_id BIGINT NULL, apiv_id BIGINT NULL) ENGINE=InnoDB;
...
ALTER TABLE contracts ADD CONSTRAINT UK_contracts_1 UNIQUE (appv_id, apiv_id, planv_id);
