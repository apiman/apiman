...
INSERT INTO gateways (id, configuration, created_by, created_on, description, modified_by, modified_on, name, type) VALUES ('TheGateway', '$CRYPT::PmrNC1m25oGSO8fC3XnxKSepmQsbxEZCldn+hYi9bQ10m8m4tEOHYU7gz5w2hcY2cMRPB3Rw+4FZYoeX0n3qEvyk+2Yf+ym3nKw3UtmtHViHLibBzWPY+8OTtJlZVb8dA8yd0TMkiwqk1WGHLSbyjmQujZ07RBK9wkwDahYwQEw=', 'admin', to_date('2015-06-18 17:56:58', 'YYYY-MM-DD HH24:MI:SS'), 'This is the gateway.', 'admin', to_date('2015-06-18 17:56:58', 'YYYY-MM-DD HH24:MI:SS'), 'The Gateway', 'REST');
...
INSERT INTO roles (id, auto_grant, created_by, created_on, description, name) VALUES ('OrganizationOwner', 1, 'admin', to_date('2015-06-18 17:56:57', 'YYYY-MM-DD HH24:MI:SS'), 'Automatically granted to the user who creates an Organization.  Grants all privileges.', 'Organization Owner');

INSERT INTO roles (id, auto_grant, created_by, created_on, description, name) VALUES ('ClientAppDeveloper', NULL, 'admin', to_date('2015-06-18 17:56:57', 'YYYY-MM-DD HH24:MI:SS'), 'Users responsible for creating and managing client apps should be granted this role within an Organization.', 'ClientApp Developer');

INSERT INTO roles (id, auto_grant, created_by, created_on, description, name) VALUES ('APIDeveloper', NULL, 'admin', to_date('2015-06-18 17:56:57', 'YYYY-MM-DD HH24:MI:SS'), 'Users responsible for creating and managing APIs should be granted this role within an Organization.', 'API Developer');
...
INSERT INTO users (username, email, full_name, joined_on) VALUES ('admin', 'admin@example.org', 'Admin', to_date('2015-06-18 17:56:54', 'YYYY-MM-DD HH24:MI:SS'));
