...
CREATE TABLE gw_clients (api_key VARCHAR(255) NOT NULL, org_id VARCHAR(150) NOT NULL, id VARCHAR(255) NOT NULL, version VARCHAR(255) NOT NULL, bean LONGTEXT NOT NULL);
...
CREATE TABLE gw_requests (
	...
	api_org_id VARCHAR(150) NOT NULL, api_id VARCHAR(150) NOT NULL, api_version VARCHAR(255) NOT NULL, 
	client_org_id VARCHAR(150), client_id VARCHAR(150), client_version VARCHAR(255), plan VARCHAR(255),
	user_id VARCHAR(150), resp_type VARCHAR(255), bytes_up BIGINT NOT NULL, bytes_down BIGINT NOT NULL
);
