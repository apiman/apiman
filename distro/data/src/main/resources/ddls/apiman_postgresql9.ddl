...
CREATE TABLE public.metadata (id BIGINT NOT NULL, exported_on TIMESTAMP WITHOUT TIME ZONE, imported_on TIMESTAMP WITHOUT TIME ZONE, apiman_version VARCHAR(255), apiman_version_at_import VARCHAR(255), success BOOLEAN);
