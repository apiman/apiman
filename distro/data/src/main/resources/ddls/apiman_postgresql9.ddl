...
CREATE SEQUENCE  IF NOT EXISTS hibernate_sequence START WITH 999;
...
CREATE TABLE permissions (role_id VARCHAR(255) NOT NULL, permissions INTEGER);
...
CREATE TABLE downloads (id VARCHAR(255) NOT NULL, type VARCHAR(255), path VARCHAR(255), expires TIMESTAMP WITHOUT TIME ZONE);

-- Changeset src/main/liquibase/current/010-apiman-manager-api.db.tables.changelog.xml::1436469846462-24::apiman (generated)
CREATE TABLE metadata (id BIGINT NOT NULL, exported_on TIMESTAMP WITHOUT TIME ZONE, imported_on TIMESTAMP WITHOUT TIME ZONE, apiman_version VARCHAR(255), apiman_version_at_import VARCHAR(255), success BOOLEAN);
...
CREATE TABLE notifications (id BIGSERIAL NOT NULL, category VARCHAR(255) NOT NULL, created_on TIMESTAMP WITHOUT TIME ZONE, modified_on TIMESTAMP WITHOUT TIME ZONE, payload JSON NOT NULL, reason VARCHAR(255) NOT NULL, reason_message VARCHAR(255) NOT NULL, recipient VARCHAR(255) NOT NULL, source VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, CONSTRAINT "notificationsPK" PRIMARY KEY (id));
...
ALTER TABLE api_plans ADD expose_in_portal BOOLEAN NOT NULL;
...
ALTER TABLE api_versions ADD expose_in_portal BOOLEAN NOT NULL;
...
ALTER TABLE api_versions ADD extended_description TEXT;
...
CREATE TABLE kv_tags (id BIGSERIAL NOT NULL, key VARCHAR(255) NOT NULL, value VARCHAR(255), CONSTRAINT "kv_tagsPK" PRIMARY KEY (id));
...
CREATE TABLE outbox (id BIGSERIAL NOT NULL, event_version BIGINT NOT NULL, payload JSON NOT NULL, source VARCHAR(255) NOT NULL, subject VARCHAR(255) NOT NULL, time TIMESTAMP WITHOUT TIME ZONE NOT NULL, type VARCHAR(255) NOT NULL, CONSTRAINT "outboxPK" PRIMARY KEY (id));
