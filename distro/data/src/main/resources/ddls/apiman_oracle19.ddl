...
CREATE TABLE notification_preferences (id NUMBER(38, 0) GENERATED BY DEFAULT AS IDENTITY NOT NULL, type VARCHAR2(255) NOT NULL, user_id VARCHAR2(255) NOT NULL, CONSTRAINT notification_preferencesPK PRIMARY KEY (id));
...
CREATE TABLE kv_tags (id NUMBER(38, 0) GENERATED BY DEFAULT AS IDENTITY NOT NULL, key VARCHAR2(255) NOT NULL, value VARCHAR2(255), CONSTRAINT kv_tagsPK PRIMARY KEY (id));
...
CREATE TABLE blob_store (id VARCHAR2(255) NOT NULL, mrblobby BLOB NOT NULL, created_on TIMESTAMP NOT NULL, hash NUMBER(38, 0) NOT NULL, mime_type VARCHAR2(255) NOT NULL, modified_on TIMESTAMP NOT NULL, name VARCHAR2(255) NOT NULL, ref_count INTEGER NOT NULL, CONSTRAINT blob_storePK PRIMARY KEY (id));
...
CREATE TABLE outbox (id NUMBER(38, 0) GENERATED BY DEFAULT AS IDENTITY NOT NULL, event_version NUMBER(38, 0) NOT NULL, payload JSON NOT NULL, source VARCHAR2(255) NOT NULL, subject VARCHAR2(255) NOT NULL, time TIMESTAMP NOT NULL, type VARCHAR2(255) NOT NULL, CONSTRAINT outboxPK PRIMARY KEY (id));
...
CREATE TABLE discoverability (id VARCHAR2(255) NOT NULL, api_id VARCHAR2(255), api_version_id NUMBER(38, 0), discoverability VARCHAR2(255), org_id VARCHAR2(255), plan_id VARCHAR2(255), plan_version_id NUMBER(38, 0), CONSTRAINT discoverabilityPK PRIMARY KEY (id));
