...
CREATE TABLE KeyValueTag (id NUMBER(38, 0) GENERATED BY DEFAULT AS IDENTITY NOT NULL, key VARCHAR2(255) NOT NULL, value VARCHAR2(255) NOT NULL, CONSTRAINT KeyValueTagPK PRIMARY KEY (id));
