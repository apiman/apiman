...
ALTER TABLE api_plans ADD discoverability VARCHAR2(255) DEFAULT 'ORG_MEMBERS';

ALTER TABLE api_versions ADD discoverability VARCHAR2(255) DEFAULT 'ORG_MEMBERS';
