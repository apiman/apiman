...
public class BundleCDIFactory {
    ...
    public static IApimanLogger provideLogger(BundleApiManagerConfig config, InjectionPoint injectionPoint) {
        try {
    ...
    public static INewUserBootstrapper provideNewUserBootstrapper(BundleApiManagerConfig config, IPluginRegistry pluginRegistry) {
    ...
    @Produces @ApplicationScoped
    public static ISecurityContext provideSecurityContext(BundleApiManagerConfig config,
    ...
    @Produces @ApplicationScoped
    public static IStorage provideStorage(BundleApiManagerConfig config, @New JpaStorage jpaStorage,
    ...
    @Produces @ApplicationScoped
    public static IStorageQuery provideStorageQuery(BundleApiManagerConfig config, @New JpaStorage jpaStorage,
    ...
    @Produces @ApplicationScoped
    public static IMetricsAccessor provideMetricsAccessor(BundleApiManagerConfig config,
    ...
    @Produces @ApplicationScoped
    public static IApiKeyGenerator provideApiKeyGenerator(BundleApiManagerConfig config,
    ...
    public static IDataEncrypter provideDataEncrypter(@New DefaultDataEncrypter defaultEncrypter,
            BundleApiManagerConfig config, IPluginRegistry pluginRegistry) {
        try {
    ...
    @Produces @ApplicationScoped
    public static IApiCatalog provideApiCatalog(BundleApiManagerConfig config, IPluginRegistry pluginRegistry) {
        try {
    ...
    public static JestClient provideStorageESClient(BundleApiManagerConfig config) {
    ...
    public static JestClient provideMetricsESClient(BundleApiManagerConfig config) {
        if ("es".equals(config.getMetricsType())) { //$NON-NLS-1$
     ...
     */
    private static JestClient createStorageJestClient(BundleApiManagerConfig config) {
     ...
     * @return create a new test ES client
     */
    private static JestClient createMetricsJestClient(BundleApiManagerConfig config) {
        StringBuilder builder = new StringBuilder();
     ...
     * @param esStorage
     */
    private static EsStorage initES(BundleApiManagerConfig config, EsStorage esStorage) {
        if (sESStorage == null) {
    ...
    private static Class<? extends IApimanDelegateLogger> getDelegate(BundleApiManagerConfig config) {
