...
public class GatewayApiTest extends TestPlanUtil {
	...
	public void testPublishApi() throws Exception {
		RestTest restTest = TestUtil.loadRestTest(restTests.get("Publish Api").test.getValue(),GatewayApiTest.class.getClassLoader());
		LOG.info("User : " + restTest.getUsername() + ", pwd : " + restTest.getPassword());
		LOG.info("Rest Path : " + restTest.getRequestPath() + ", Method : " + restTest.getRequestMethod() + ", Payload : " + restTest.getRequestPayload());
	...
	public void runTest(RestTest restTest, String baseApiUrl) throws Error {
		try {
			...
			System.out.println("Sending HTTP request to: " + uri);
