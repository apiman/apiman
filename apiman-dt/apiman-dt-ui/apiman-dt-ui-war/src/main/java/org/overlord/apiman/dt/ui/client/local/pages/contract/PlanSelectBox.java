...
public class PlanSelectBox extends SelectBox<ServicePlanSummaryBean> {
     ...
     */
    @Override
    protected String optionName(ServicePlanSummaryBean option) {
        return option.getPlanName();
    }
     ...
     */
    @Override
    protected String optionValue(ServicePlanSummaryBean option) {
        return option.getPlanId();
    }
