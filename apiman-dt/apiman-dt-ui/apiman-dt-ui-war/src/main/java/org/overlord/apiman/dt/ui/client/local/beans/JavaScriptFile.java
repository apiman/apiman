...
public class JavaScriptFile {
    ...
    public native void readAsText(IDataReadHandler handler) /*-{
        ...
        reader.onload = function(e) {
            ...
            handler.@org.overlord.apiman.dt.ui.client.local.beans.JavaScriptFile.IDataReadHandler::onDataLoaded(Ljava/lang/String;)(value);
        }
        reader.readAsText(this.@org.overlord.apiman.dt.ui.client.local.beans.JavaScriptFile::jsFile);
    }-*/;
