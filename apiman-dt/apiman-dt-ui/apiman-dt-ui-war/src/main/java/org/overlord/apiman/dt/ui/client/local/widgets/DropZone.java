    ...
    public final native void handleFiles(DataTransfer dt) /*-{
        if (dt && dt.files) {
            ...
            for (var i = 0; i < files.length; i++) {
                var file = files[i];
                if (this.@org.overlord.apiman.dt.ui.client.local.widgets.DropZone::accept(Ljava/lang/String;ILjava/lang/String;)(file.name, file.size, file.type)) {
                    this.@org.overlord.apiman.dt.ui.client.local.widgets.DropZone::addFile(Lcom/google/gwt/core/client/JavaScriptObject;)(file);
                }
            }
        }
    }-*/;
