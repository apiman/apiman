...
public class Config implements IConfig {
    ...
    private static final String APIMAN_DT_API_CONFIG_FILE_NAME     = "apiman-dt-api.config.file.name"; //$NON-NLS-1$
    private static final String APIMAN_DT_API_CONFIG_FILE_REFRESH  = "apiman-dt-api.config.file.refresh"; //$NON-NLS-1$
