#!/bin/sh
mvn clean install
cp -rf crash-course/target/docbook/publish/en-US/html/* ../apiman.github.io/latest/crash-course/.
cp -rf crash-course/en-US/images/* ../apiman.github.io/latest/images/images
...
cp crash-course/target/docbook/publish/en-US/pdf/apiman-crash-course.pdf ../apiman.github.io/latest/crash-course/.
