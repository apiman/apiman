...
* http://downloads.jboss.org/overlord/apiman/1.1.5.Final/apiman-distro-wildfly8-1.1.5.Final-overlay.zip[Download apiman 1.1.5.Final]

....
curl http://download.jboss.org/wildfly/8.2.0.Final/wildfly-8.2.0.Final.zip -o wildfly-8.2.0.Final.zip
curl http://downloads.jboss.org/overlord/apiman/1.1.5.Final/apiman-distro-wildfly8-1.1.5.Final-overlay.zip -o apiman-distro-wildfly8-1.1.5.Final-overlay.zip
....
...
unzip -o apiman-distro-wildfly8-1.1.5.Final-overlay.zip -d wildfly-8.2.0.Final
....
