...
*/
public class PolicyToIngestorServiceVertxEBProxy implements PolicyToIngestorService {

  private Vertx _vertx;
  private String _address;
  private boolean closed;

  public PolicyToIngestorServiceVertxEBProxy(Vertx vertx, String address) {
    this._vertx = vertx;
