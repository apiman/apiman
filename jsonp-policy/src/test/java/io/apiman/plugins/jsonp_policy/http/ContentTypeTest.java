...
public class ContentTypeTest {
	...
	public void testGetTypeSubtype() {
		...
		assertEquals("application/vnd.oasis.opendocument.text", new ContentType("  application/vnd.oasis.opendocument.text ; charset=UTF-8 ; version=1 ").getTypeSubtype());
	}
	...
	public void testGetCharset() {
		...
		assertEquals("ISO-8859-1", new ContentType("  application/vnd.oasis.opendocument.text ;  charset=ISO-8859-1 ; version=1  ").getCharset());
	}
	...
	public void testToString() throws Exception {
		...
		assertEquals("application/vnd.oasis.opendocument.text; charset=ISO-8859-1; version=1", new ContentType("  application/vnd.oasis.opendocument.text ;  charset=ISO-8859-1 ; version=1  ").toString());
	}
