...
* IP Address HTTP Header - This is an optional parameter that can be used to provide addition information.
* Failure Response - The server response code. The possible values for the return code are:
 ** 500 - Server error
 ** 404 - Not found
 ** 403 - Authentication failure
* IP Addresses - The IP address, and/or ranges of addresses that will be permitted to access the configured API. 
...
```json
{
    ...
    "configuration" : "{\"ipList\":[\"192.168.3.*\",\"192.168.4.*\"],\"responseCode\":\"500\",\"httpHeader\":\"This is the optional IP Address HTTP Header\"}",
    "createdBy" : "admin",
    "createdOn" : "2016-04-06T19:40:20Z",
    "modifiedBy" : "admin",
    "modifiedOn" : "2016-04-06T19:40:20Z",
    "definition" : {
 ...
 ** 404 - Not found
 ** 403 - Authentication failure
* IP Addresses - The IP address, and/or ranges of addresses that will be blocked from accessing the configured API. 
...
```json
{
    ...
    "configuration" : "{\"ipList\":[\"192.168.7.*\"],\"responseCode\":\"500\",\"httpHeader\":\"Optional IP Blacklist HTTP Header\"}",
    "createdBy" : "admin",
    "createdOn" : "2016-04-06T20:21:35Z",
    "modifiedBy" : "admin",
    "modifiedOn" : "2016-04-06T20:21:35Z",
    "definition" : {
...
===== Description
The ignored resources policy type enables you to shield some of an API’s resources from being accessed, without blocking access to all the API’s resources. Requests made to access to API resources designated as “ignored” result in an HTTP 404 (“not found”) error code. By defining ignored resource policies, apiman enables you to have fine-grained control over which clients can access an API’s resources. 
...
| :----------------------------- |:-----------------------------------------:| 
| (empty)                        | Access to all resources are allowed |
 ...
 * The list of regular expressions representing the resources to be ignored.
* The HTTP verb to be controlled by the policy. Valid values are:
  ** GET
  ** POST
  ** PUT
  ** DELETE
...
```json
{
    ...
    "configuration" : "{\"rules\":[{\"verb\":\"GET\",\"pathPattern\":\"/customers\"},{\"verb\":\"GET\",\"pathPattern\":\"/customers/./orders\"},{\"verb\":\"GET\",\"pathPattern\":\"/customers/.*/orders/bad_debts\"}]}",
    "createdBy" : "admin",
    "createdOn" : "2016-04-06T20:27:31Z",
    "modifiedBy" : "admin",
    "modifiedOn" : "2016-04-06T20:27:31Z",
    "definition" : {
...
* Number of requests - This is the number of requests that must be met to trigger the policy.
* Granularity - The apiman element for which the requests are counted. Valid values are:
  ** Client App
  ** User
  ** API
* Period - The time period over which the policy is applied. Valid values are:
  ...
  ** Month
  ** Year
* Limit Response Header - An optional header to be added to a response. 
* Remaining Response Header - An optional header to be added to a response to indicate the level remaining until the policy limit is reached.
* Reset Response Header - An optional header to be added to a response when the policy limit is reset.
...
```json
{
    ...
    "configuration" : "{\"limit\":10,\"granularity\":\"Api\",\"period\":\"Minute\",\"headerLimit\":\"Optional response header\",\"headerRemaining\":\"Optional remaining response header\",\"headerReset\":\"Optional response header\"}",
    "createdBy" : "admin",
    "createdOn" : "2016-04-06T20:31:02Z",
    "modifiedBy" : "admin",
    "modifiedOn" : "2016-04-06T20:31:02Z",
    "definition" : {
...
```json
{
    ...
    "configuration" : "{\"limit\":10240,\"headerLimit\":\"Transfer quota optional limit response header\",\"direction\":\"upload\",\"granularity\":\"Client\",\"period\":\"Minute\",\"headerRemaining\":\"Transfer quota optional remaining response header\",\"headerReset\":\"Transfer quota optional reset response header\"}",
    "createdBy" : "admin",
    "createdOn" : "2016-04-06T20:39:30Z",
    "modifiedBy" : "admin",
    "modifiedOn" : "2016-04-06T20:39:30Z",
    "definition" : {
...
* Transfer quota - The limit to be assigned to the transfer quote. The calid units of measure are:
  ** Bytes
  ** KB
  ** MB
  ** GB
