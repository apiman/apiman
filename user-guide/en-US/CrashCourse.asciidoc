...
|===
| Gold plan
a| * A coarse grained Quota plan with a limit of 100,000 API requests per month, and

| Silver plan
a| * A coarse grained Quota plan with a limit of 20,000 API requests per month, and
|===
