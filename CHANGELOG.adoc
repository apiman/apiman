...
If you are using MSSQL, you should set the Java system property `hibernate.auto_quote_keyword=true` — in WildFly you can put this into the `properties` section of `standalone-apiman.xml`.
