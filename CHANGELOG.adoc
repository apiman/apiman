...
* [distro]: bump minimum version of Postgres from 9.x to 10.x. PGES 9.x does not support the `create or replace procedure` syntax we use, and the 9.x lineage is not supported upstream any more.
