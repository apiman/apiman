 ...
 */
public class FuseHttpConnectorFactory implements IConnectorFactory {
     ...
     * Constructor.
     */
    public FuseHttpConnectorFactory() {
    }
    ...
    protected ServiceResponse doInvoke(ServiceRequest request, Service service) throws ConnectorException {
        ...
        if ("GET".equals(request.getType())) { //$NON-NLS-1$
            ...
            throw new ConnectorException("Method not supported: " + request.getType()); //$NON-NLS-1$
        }
        ...
        try {
            ...
            sresponse = FuseGatewayThreadContext.getServiceResponse();
            ...
            throw new ConnectorException("Error invoking service.", e); //$NON-NLS-1$
        }
    }
