 ...
 */
public class OrganizationsTest extends AbstractTestPlanTest {
    ...
    @Test
    public void test() {
        runTestPlan("test-plans/organizations-testPlan.xml", OrganizationsTest.class.getClassLoader()); //$NON-NLS-1$
    }
