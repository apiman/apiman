 ...
 */
public class PolicyDefinitionsTest extends AbstractTestPlanTest {
    ...
    @Test
    public void test() {
        runTestPlan("test-plans/policyDefs-testPlan.xml", PolicyDefinitionsTest.class.getClassLoader()); //$NON-NLS-1$
    }
