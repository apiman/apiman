 ...
 */
public class PolicyChainTest extends AbstractTestPlanTest {
    ...
    @Test
    public void test() {
        runTestPlan("test-plans/policychain-testPlan.xml", PolicyChainTest.class.getClassLoader()); //$NON-NLS-1$
    }
