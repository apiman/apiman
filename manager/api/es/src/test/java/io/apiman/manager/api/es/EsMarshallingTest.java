...
//         return createBean_(beanClass, new HashSet<>());
//     }
//
//
//     /**
...
//      */
//     private static <T> T createBean_(Class<T> beanClass, Set<String> cycleDetector) throws InstantiationException, IllegalAccessException,
//             InvocationTargetException, NoSuchMethodException, SecurityException, ClassNotFoundException {
...
//                     if (cycleDetector.contains(fieldType.getCanonicalName())) {
//                         System.out.println("Seen before, ignore " + fieldType.getCanonicalName());
//                         continue;
//                     }
//                     System.out.println("Pushing " + fieldType.getCanonicalName());
//                     cycleDetector.add(fieldType.getCanonicalName());
//                     Object childBean = createBean_(fieldType, cycleDetector);
