...
_module.controller("Apiman.PlanRedirectController",
...
_module.factory('PlanEntityLoader',
...
_module.controller("Apiman.PlanEntityController",
    ['$q', '$uibModal', '$scope', '$location', 'ActionSvcs', 'Logger', 'PageLifecycle', '$routeParams', 'OrgSvcs', 'EntityStatusSvc',
    function ($q, $uibModal, $scope, $location, ActionSvcs, Logger, PageLifecycle, $routeParams, OrgSvcs, EntityStatusSvc) {
        var params = $routeParams;
