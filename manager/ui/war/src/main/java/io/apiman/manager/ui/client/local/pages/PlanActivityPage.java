...
import io.apiman.manager.ui.client.local.pages.common.ActivityList;
 ...
 */
@Templated("/io/apiman/manager/ui/client/local/site/plan-activity.html#page")
@Page(path="plan-activity")
@Dependent
public class PlanActivityPage extends AbstractPlanPage {
    ...
    protected int doLoadPageData() {
        ...
        rest.getPlanActivity(org, plan, 1, PAGE_SIZE, new IRestInvokerCallback<SearchResultsBean<AuditEntryBean>>() {
            @Override
    ...
    protected void onNextActivityItems() {
        page++;
        rest.getPlanActivity(org, plan, page, PAGE_SIZE, new IRestInvokerCallback<SearchResultsBean<AuditEntryBean>>() {
            @Override
            public void onSuccess(SearchResultsBean<AuditEntryBean> response) {
    ...
    protected String getPageTitle() {
        return i18n.format(AppMessages.TITLE_PLAN_ACTIVITY, planBean.getName());
    }
