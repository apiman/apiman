 ...
 */
@Dependent
public class AddPolicyDetailPanel extends AbstractDetailPanel {

    /**
     * Constructor.
     */
    public AddPolicyDetailPanel() {
    }
    ...
    public void render(AuditEntryBean entry) {
        ...
        add(new SpanLabel(i18n.format(AppMessages.ACTIVITY_DATA_POLICY_ADDED)));
