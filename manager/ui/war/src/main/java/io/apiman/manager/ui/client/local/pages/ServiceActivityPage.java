 ...
 */
@Templated("/io/apiman/manager/ui/client/local/site/service-activity.html#page")
...
public class ServiceActivityPage extends AbstractServicePage {
    ...
    protected int doLoadPageData() {
        ...
        rest.getServiceActivity(org, service, 1, PAGE_SIZE, new IRestInvokerCallback<SearchResultsBean<AuditEntryBean>>() {
            @Override
    ...
    protected void onNextActivityItems() {
        page++;
        rest.getServiceActivity(org, service, page, PAGE_SIZE, new IRestInvokerCallback<SearchResultsBean<AuditEntryBean>>() {
            @Override
            public void onSuccess(SearchResultsBean<AuditEntryBean> response) {
    ...
    protected String getPageTitle() {
        return i18n.format(AppMessages.TITLE_SERVICE_ACTIVITY, serviceBean.getName());
    }
