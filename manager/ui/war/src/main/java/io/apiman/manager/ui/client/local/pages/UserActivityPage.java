 ...
 */
@Templated("/io/apiman/manager/ui/client/local/site/user-activity.html#page")
...
public class UserActivityPage extends AbstractUserPage {
    ...
    protected int doLoadPageData() {
        ...
        rest.getUserActivity(user, 1, PAGE_SIZE, new IRestInvokerCallback<SearchResultsBean<AuditEntryBean>>() {
            @Override
    ...
    protected void onNextActivityItems() {
        page++;
        rest.getUserActivity(user, page, PAGE_SIZE, new IRestInvokerCallback<SearchResultsBean<AuditEntryBean>>() {
            @Override
            public void onSuccess(SearchResultsBean<AuditEntryBean> response) {
