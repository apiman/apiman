var APIMAN_TRANSLATION_DATA = {
  ...
  "republish.placeholder": "Publishing...",
  ...
  "name-error": "Error: Invalid name entered. Names can only use alphanumeric characters, underscores, and dashes.",
  "text-error": "Error: Invalid text entered. Text fields can only use alphanumeric characters, underscores, dashes, spaces, periods, and commas.",
  "version-error": "Error: Invalid version entered. The version must be numbers separated by periods.",
  "path-error": "Error: Invalid path entered. Paths can only use alphanumeric characters, underscores, dashes, periods, forward slashes, and asterisk",
  "": "s.",
  "required-error": "Error: The value is required.",
  "password-error": "Error: The password and confirmation values are required and must match.",
  "json-error": "Error: Invalid JSON entered.",
  "regexp-error": "Error: Invalid regular expression entered.",
  "endpoint-error": "Error: Invalid gateway endpoint. Must be unique and must match \"${apiman.gateway-endpoint:http[s]://host[:port]/apiman-gateway-a",
  "pi} or http[s]": "//host[:port]/apiman-gateway-api\"",
  "email-error": "Error: Invalid email address entered.",
  "no-definition": "No API Definition",
  "json-definition": "Swagger (JSON)",
  "yaml-definition": "Swagger (YAML)",
  "wsdl-definition": "Web Service Definintion Language (WSDL)"
};