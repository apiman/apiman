...
module Apiman {
    ...
    _module.config(['$locationProvider', '$routeProvider', 'HawtioNavBuilderProvider',
        ($locationProvider, $routeProvider: ng.route.IRouteProvider, builder: HawtioMainNav.BuilderFactory) => {
            ...
            $routeProvider.when('/apiman/dash.html', {
                templateUrl: builder.join(Apiman.templatePath, 'dash.html'),
            ...
            $routeProvider.when('/apiman/org-plans.html', {
                templateUrl: builder.join(Apiman.templatePath, 'org-plans.html'),
                controller: 'Apiman.OrgPlansController'
            });
