 ...
 * end API/service.  This interface is that simulation.  Tests can provide
 * their own custom service implementation, or simply allow the test framework
 * to use the default "echo" service.
 *
...
public interface IPolicyTestBackEndService {
     ...
     */
    PolicyTestBackEndServiceResponse invoke(ServiceRequest request, byte[] requestBody);
